  ...
  const submitHandler = async (e) => {
    ...
    if (password !== confirmPassword) {
      ...
      try {
        ...
        const tx = await userContract.addUniversity(
          instituteName,
          instituteCode,
          password,
          { gasLimit: gasLimit }
  ...
  return (
    <>
      <div className="bg-img-institute h-screen bg-cover ">
        ...
        <div className="flex flex-col justify-center bg-slate-200 max-w-fit rounded-lg m-32 p-8 grid grid-cols-1">
          ...
          <div className="m-4">
            <button
              className="bg-yellow-400 text-lg p-2 rounded-lg border-2 border-slate-400 hover:bg-yellow-200"
